...
insert into public.levels (id, map_id, level_index, difficulty, name, is_boss, enemy_config) values
  ('finale_1', 'finale', 1, 52, 'Les Sentinelles du Seuil', false,
   '{"enemies":[
      {"name":"Sentinelle du Seuil","hp":1500,"atk":200,"def":56,"armor":60,"speed":13,"abilities":[{"kind":"on_hit","chance":0.18,"status":"weaken","potency":0.15,"duration":2}]},
      {"name":"Sentinelle du Seuil","hp":1500,"atk":200,"def":56,"armor":60,"speed":13,"abilities":[{"kind":"on_hit","chance":0.18,"status":"weaken","potency":0.15,"duration":2}]}
    ]}'::jsonb),
  ('finale_2', 'finale', 2, 54, 'Les Hérauts de l''Aube', false,
   '{"enemies":[
      {"name":"Héraut de l''Aube","hp":1750,"atk":225,"def":62,"armor":64,"speed":12,"abilities":[{"kind":"on_hit","chance":0.16,"status":"stun","duration":1}]},
      {"name":"Héraut de l''Aube","hp":1750,"atk":225,"def":62,"armor":64,"speed":12,"abilities":[{"kind":"on_hit","chance":0.16,"status":"stun","duration":1}]},
      {"name":"Héraut de l''Aube","hp":1750,"atk":225,"def":62,"armor":64,"speed":12,"abilities":[{"kind":"on_hit","chance":0.16,"status":"stun","duration":1}]}
    ]}'::jsonb),
  ('finale_3', 'finale', 3, 56, 'L''Aube Première', true,
   '{"enemies":[
      {"name":"L''Aube Première","hp":10500,"atk":560,"def":100,"armor":72,"speed":11,"abilities":[
